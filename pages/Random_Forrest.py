...
glucose = st.slider("🍬 Glucose Level", 0, 250, 90, help="Normal glucose level (mg/dL)")
blood_pressure = st.slider("💉 Blood Pressure", 0, 130, 75, help="Normal diastolic blood pressure (mm Hg)")
skin_thickness = st.slider("📏 Skin Thickness", 0, 100, 20, help="Normal skinfold thickness (mm)")
insulin = st.slider("💉 Insulin Level", 0, 850, 30, help="Normal insulin level (μU/mL)")
